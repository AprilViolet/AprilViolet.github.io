...
Carousel.prototype = {
    ...
    createDOM:function(container,options){
        ...
        for(var i = 0;i<imgLength;i++){
            ...
            console.log(options.datas[i].url);
    ...
    changeZindex_sub:function(){
        ...
        $(".vertical-box ul").find("li").eq(1).find("img").attr("src",lastImgSrc);
        $(".vertical-box ul").find("li").eq(1).find("a").attr("href",lastImgUrl);
...
$(document).ready(function () {
    $.getJSON("./data/main-banner.json", function (data) {
